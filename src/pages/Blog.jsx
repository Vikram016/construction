...
const Blog = () => {
  ...
  const categories = ['All', 'Construction Tips', 'Material Guide', 'Cost Saving', 'Seasonal Tips', 'Material Comparison', 'Quality Control'];
  ...
  return (
    <>
      <PageSEO
        ...
        breadcrumbs={[{ name: 'Home', url: SITE.url }, { name: 'Blog', url: SITE.url + '/blog' }]}
      />
        ...
        <div className="container-custom">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-neutral-300 mb-8">
              Expert insights on construction materials, tips, and industry best practices
            </p>
            ...
            <div className="relative max-w-xl">
              ...
              />
              <svg className="absolute right-4 top-1/2 transform -translate-y-1/2 w-6 h-6 text-neutral-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="container-custom">
          <div className="mb-6">
            <p className="text-neutral-600">
              Showing <span className="font-bold text-neutral-900">{filteredBlogs.length}</span> articles
      ...
      <section className="py-16 bg-construction-dark text-white">
        <div className="container-custom text-center">
          ...
          <p className="text-xl text-neutral-300 mb-8 max-w-2xl mx-auto">
            Browse our products or contact us for expert advice on your construction needs
          </p>
