...
const Products = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Category Filter */}
      <section className="bg-white border-b-4 border-construction-yellow sticky top-20 z-40 shadow-md">
      ...
      {/* Products Grid */}
      <section className="py-12 industrial-grid">
        <div className="container mx-auto px-4">
          <div className="mb-6">
          ...
          {filteredProducts.length === 0 ? (
            <div className="text-center py-20">
              <p className="text-2xl text-construction-mediumGray">No products found in this category</p>
            </div>
          ) : (
      ...
      {/* CTA Section */}
      <section className="bg-construction-yellow py-12">
        <div className="container mx-auto px-4 text-center">
          <h2 className="font-display text-4xl text-construction-darkGray mb-4">
            CAN'T FIND WHAT YOU NEED?
          </h2>
          <p className="text-construction-darkGray mb-6 max-w-2xl mx-auto">
