  ...
  const values = [
    {
      ...
      title: "Quality First",
      description:
        "We source only premium-grade construction materials from certified manufacturers.",
    },
    {
      icon: "⚡",
      title: "Fast Delivery",
      description:
        "Quick and reliable delivery within 24-48 hours to your construction site.",
    },
    {
      icon: "💰",
      title: "Best Prices",
    ...
    },
    {
      ...
      description:
        "Trusted by thousands of builders, contractors, and homeowners across India.",
    },
  ];
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-4 text-neutral-700">
                  <p>
                    Founded in 2014, AnjaneyaDealers started with a simple
                    vision: to make quality construction materials accessible to
                    everyone. What began as a small warehouse in Bangalore has
                    grown into one of India's most trusted construction
                    materials suppliers.
                  </p>
                  <p>
                    We understand that building a home or a commercial space is
                    one of the most important investments you'll make. That's
                    why we're committed to providing only the best materials at
                    competitive prices, with service that goes beyond just
                    delivery.
                  </p>
                  <p>
                    Today, we serve thousands of customers across Karnataka,
        ...
        <div className="bg-construction-yellow py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-lg mb-8 text-neutral-800">
              Get a free quote or browse our products to find exactly what you
              need
            </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-3 gap-8 text-center">
              ...
              <div>
                ...
                <p className="text-neutral-700">
                  sales@AnjaneyaDealers.com
                  <br />
                  support@AnjaneyaDealers.com
                </p>
              </div>
            </div>
          </div>
