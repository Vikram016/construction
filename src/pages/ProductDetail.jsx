...
Please confirm this order and provide final pricing. Thank you!`;
  ...
  return (
    <div className="min-h-screen">
      {/* Breadcrumb */}
      <div className="bg-construction-lightGray py-4 border-b-2 border-construction-yellow">
        <div className="container mx-auto px-4">
          <div className="flex items-center space-x-2 text-sm">
            ...
            <span>/</span>
            <span className="text-construction-mediumGray">{product.name}</span>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div>
            <div className="bg-construction-yellow inline-block px-3 py-1 font-bold text-sm uppercase mb-4">
              {product.category}
            </div>
            <h1 className="font-display text-5xl mb-4">{product.name}</h1>
            <p className="text-lg text-construction-mediumGray mb-6">
              {product.description}
            </p>

            {/* Image */}
            <div className="mb-8 overflow-hidden shadow-xl border-4 border-construction-darkGray">
              <img 
                src={product.image} 
                alt={product.name}
            ...
            {/* Price Info */}
            <div className="bg-construction-darkGray text-white p-6 mb-6">
              <div className="flex justify-between items-end">
                <div>
                  <div className="text-sm uppercase tracking-wider mb-1">Base Price</div>
                  <div className="font-display text-5xl text-construction-yellow">
                    ₹{product.basePrice}
                  </div>
                  <div className="text-sm">per {product.unit}</div>
                </div>
                <div className="text-right">
                  <div className="text-sm uppercase tracking-wider mb-1">GST</div>
                  <div className="font-display text-3xl text-construction-yellow">
            ...
            {/* Features */}
            <div className="bg-white border-l-4 border-construction-yellow p-6">
              <h3 className="font-display text-2xl mb-4">PRODUCT FEATURES</h3>
              <ul className="space-y-2">
                <li className="flex items-start space-x-2">
                  <span className="text-construction-yellow text-xl">✓</span>
                  <span>Premium quality certified materials</span>
                </li>
                <li className="flex items-start space-x-2">
                  <span className="text-construction-yellow text-xl">✓</span>
                  <span>Direct from manufacturer/supplier</span>
                </li>
                <li className="flex items-start space-x-2">
                  <span className="text-construction-yellow text-xl">✓</span>
                ...
                <li className="flex items-start space-x-2">
                  <span className="text-construction-yellow text-xl">✓</span>
                  <span>Fast delivery with proper transport</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div>
            <div className="sticky top-24">
              <div className="bg-white shadow-2xl border-t-8 border-construction-yellow p-6">
                <h2 className="font-display text-3xl mb-6">GET INSTANT QUOTE</h2>
                ...
                <button
                  ...
                  className="w-full bg-construction-mediumGray text-white py-3 px-6 font-bold uppercase mb-6 hover:bg-construction-darkGray transition-colors disabled:opacity-50"
                >
                  {distanceLoading ? 'Calculating...' : 'Calculate Distance & Transport'}
                </button>

                {distanceError && (
                  <div className="bg-red-100 border-l-4 border-red-500 p-3 mb-6">
                    <p className="text-sm text-red-700">{distanceError}</p>
                  </div>
                )}

                {distance && (
                  <div className="bg-construction-yellow p-4 mb-6">
                    <div className="flex items-center justify-between mb-2">
                      <span className="font-bold uppercase text-sm">Distance</span>
                      <span className="font-display text-2xl">{distance.distanceText}</span>
                    </div>
                    {distance.isFallback && (
                ...
                {/* Cost Breakdown */}
                <div className="bg-construction-lightGray p-6 mb-6">
                  <h3 className="font-display text-xl mb-4">COST BREAKDOWN</h3>
                  ...
                  <div className="space-y-3 mb-4">
                    ...
                    {transportCalculation ? (
                      <>
                        <div className="flex justify-between">
                          <span className="text-sm">Vehicle: {transportCalculation.vehicle.name}</span>
                        </div>
                        <div className="flex justify-between text-sm">
                        ...
                        <div className="flex justify-between text-sm">
                          <span>Distance Charge ({distance.distance}km @ ₹{transportCalculation.breakdown.perKmRate}/km)</span>
                      ...
                      <div className="text-sm text-construction-mediumGray italic">
                        Calculate distance to see transport cost
                      </div>
                    )}
                  </div>

                  <div className="border-t-2 border-construction-darkGray pt-4">
                    <div className="flex justify-between items-end">
                      <span className="font-display text-xl">ESTIMATED TOTAL</span>
                      <span className="font-display text-3xl text-construction-orange">
                ...
                <div className="mb-6">
                  <label className="flex items-center space-x-3 cursor-pointer">
                    <input
                      ...
                      className="w-5 h-5"
                    />
                    <span className="font-bold">GST Invoice Required</span>
                  </label>
                </div>
                ...
                <button
                  ...
                  className="w-full btn-primary flex items-center justify-center space-x-3 mb-4"
                >
                ...
                <p className="text-xs text-center text-construction-mediumGray italic">
