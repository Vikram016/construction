    ...
    <footer className="bg-neutral-950 text-white" role="contentinfo">
      ...
      <div className="bg-orange-500 py-5">
        <div className="container-custom flex flex-col sm:flex-row items-center justify-between gap-4">
          <div>
            <p className="font-black text-neutral-900 text-lg leading-tight">Ready to book a service?</p>
            <p className="text-neutral-800 text-sm">WhatsApp us now — we reply in under 5 minutes.</p>
          </div>
          <div className="flex gap-3 shrink-0">
            <a href={`https://wa.me/${whatsapp}?text=Hi! I'd like to book a BuildMart service in Bangalore.`}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <div className="flex items-center gap-2.5 mb-5">
              ...
              <div>
                <p className="font-black text-white text-xl leading-tight">BuildMart</p>
                <p className="text-neutral-500 text-xs">Premium Construction Materials</p>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <FooterLink to="/services/waste-sand">🏗️ Waste Sand Collection</FooterLink>
              <FooterLink to="/services/debris-sand">♻️ Debris Sand Delivery</FooterLink>
              <FooterLink to="/services/site-clean">🧹 Site Cleaning</FooterLink>
            </ul>
          ...
          <div>
            ...
            <div className="mt-5 bg-neutral-900 rounded-xl p-4 border border-neutral-800">
              <p className="text-xs font-black text-neutral-400 uppercase tracking-widest mb-2">Business Hours</p>
              <p className="text-sm text-neutral-300">{hours.weekdays}</p>
              <p className="text-sm text-neutral-500">{hours.weekend}</p>
              <p className="text-xs text-orange-400 mt-1 font-semibold">{hours.emergency}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-neutral-800 py-5">
        <div className="container-custom flex flex-col sm:flex-row justify-between items-center gap-3 text-xs text-neutral-600">
          <p>© {year} BuildMart · {address.city}, {address.state}, {address.country}. All rights reserved.</p>
          <p>Prices are estimates. Final pricing confirmed on WhatsApp or call.</p>
        </div>
      </div>
