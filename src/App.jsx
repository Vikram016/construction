...
const PageLoader = () => (
  <div className="min-h-[60vh] flex items-center justify-center bg-neutral-50">
    <div className="flex flex-col items-center gap-4">
      ...
      <p className="text-sm font-semibold text-neutral-400 uppercase tracking-wider">Loading…</p>
    </div>
  </div>
);
...
class ErrorBoundary extends Component {
  ...
  componentDidCatch(e, info) { console.error('[BuildMart]', e, info.componentStack); }
  render() {
      ...
      <div className="min-h-[70vh] flex items-center justify-center bg-neutral-50 px-4">
        <div className="max-w-md text-center">
          ...
          <details className="mt-6 text-left bg-red-50 border border-red-200 rounded-xl p-4">
            <summary className="cursor-pointer font-bold text-red-700 text-sm">Error details</summary>
                  ...
                  <ErrorBoundary>
                    <Suspense fallback={<PageLoader />}>
                      <Routes>
                        ...
                        <Route path="/services/waste-sand"  element={<WasteSandBooking />} />
                        <Route path="/services/debris-sand" element={<DebrisSandBooking />} />
                        <Route path="/services/site-clean"  element={<SiteClean />} />

                        {/* ── Legacy redirects — keeps any old links alive ── */}
                        <Route path="/waste-sand"   element={<Navigate to="/services/waste-sand"  replace />} />
                        <Route path="/debris-sand"  element={<Navigate to="/services/debris-sand" replace />} />
                        <Route path="/site-clean"   element={<Navigate to="/services/site-clean"  replace />} />
                      </Routes>
                    </Suspense>
                  </ErrorBoundary>
                </main>
